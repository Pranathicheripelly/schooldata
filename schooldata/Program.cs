...
namespace schooldata
{
    ...
    class program
    {
        static void Main()
        {
            ...
            var student1 = SchoolFactory.CreateStudent("Student A", "Class X");
            var student2 = SchoolFactory.CreateStudent("Student B", "Class Y");

            var teacher1 = SchoolFactory.CreateTeacher(" smith", "Class X");
            var teacher2 = SchoolFactory.CreateTeacher("john ", "Class Y");
